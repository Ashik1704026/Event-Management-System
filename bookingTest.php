  ...
  <select name="cars" id="cars" required>
    ...
    <option >Audi</option>
                      	...
                      	<div class="col-sm-10 col-md-10 col-lg-10">
							<div class="row ml-2">
								<div class="col-lg-4 col-md-4 form-check form-check-inline">
									<input class="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="Wedding" required>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-10">
						<select class="form-control form-control-lg" name="venue" id="venue" required>
						    <option value = "" selected>--Select--</option>
						</select>
					</div>
                </div>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<input type='text' class="form-control datepicker Scalendar" name ="startDate" id = "SDate" required/>
						</div>
					</div>
                </div>
                <div class="form-group row">
					...
					<div class="col-sm-10 ">
						...
						<input type='text' class="form-control datepicker Lcalendar" name = "lstDate" id="LDate" required/>
						</div>
					</div>
                </div>
                <div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control form-control-lg" id="NOofPerson" placeholder="**Total perticipant number can not be less than Fifty(50)**  Ex 250" name = "Person_num" required>
					</div>
                </div>
                <!-- <input type="submit" value = "SUBMIT" class="btn btn-outline-warning btn-lg btn-block mb-2" name = "submit" > -->
                <input type="submit" value = "SUBMIT" class="btn btn-outline-warning btn-lg btn-block mb-2" name = "submit" data-toggle="modal" data-target="#BookConfirmModal" onclick = "showMessage();" >
        ...
        $(document).ready(function(){
            $("#location").change(function(){
                ...
                $.ajax({
                    ...
                    $('#venue').empty();
                    $('#venue').append('<option value = "">' + '--Select--' + '</option>');
